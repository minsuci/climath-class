// ⚠⚠ 2026-09-08: 이 파일은 **팀체크로 옮겨갔다** (climath-team/api/schedule.js).
//     여기 것은 아무도 안 부른다. 되돌릴 때를 위해 한동안 남겨 둔 사본이다 —
//     팀체크 쪽이 한 회차 돌아간 것을 보고 지운다. **여기를 고치지 마라. 저쪽을 고쳐라.**
//     (옮긴 이유: 팀체크가 학교 일정을 채우는데 찾아오는 코드가 여기 있어서,
//      가정통신문에서 수학시험 시간표를 긁는 일을 하려면 남의 앱을 고쳐야 했다.)
